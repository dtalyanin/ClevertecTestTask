...
public class JsonDeserializer {
    ...
    private int getLastIndexOfWrappingValue(String strObject, char enclosingChar) {
        int lastValueIndex = strObject.lastIndexOf(enclosingChar) + 1;
        if (lastValueIndex == 0) {
            throw new JsonException("Missing closing value " + enclosingChar);
        }
        return lastValueIndex;
    }
